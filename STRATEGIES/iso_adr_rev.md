# iso_adr_rev — ISO ADR Reversal Short

## Signal
Price at top of 24-candle range with volume confirmation in calm market.
...
## Performance
RUN6.1. ISO version of short_adr_rev for calm markets.
