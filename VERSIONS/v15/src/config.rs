...
// ── COINCLAW v15: Revert scalp to v9 volume-based edge ───────────────────────
// 4-day live test showed v9 (high volume scalps) outperforms v13/v14 (filtered).
// Scalp TP reverted 0.8%→0.2%, removed cooldowns/direction matching/squeeze block,
// restored vol_spike_rev + bb_squeeze_break entries. Regime trades unchanged.
// Momentum breakout layer (RUN27/28) retained from v14.
#[derive(Debug, Clone)]
...
// Scalp overlay params (v15: revert to v9 tight TP for volume-based edge)
pub const SCALP_SL: f64 = 0.001;
pub const SCALP_TP: f64 = 0.002;      // v9 value: 0.2% TP (was 0.8% in v10-v14)
