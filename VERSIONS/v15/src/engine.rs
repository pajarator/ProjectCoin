...
/// v15: revert to v9 scalp behavior — no cooldowns, no direction matching, no squeeze block.
/// Scalps are a volume game with small positive edge; filters destroy volume faster than they
/// improve quality. 4 days of live testing confirmed v9 (high volume) outperforms v13/v14 (filtered).
