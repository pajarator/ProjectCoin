...
// RUN82: Regime decay exit — early exit when ADX rises significantly above entry
pub const REGIME_DECAY_ENABLE: bool = true;
pub const REGIME_DECAY_ADX_RISE: f64 = 25.0;   // ADX must rise this much above entry ADX
pub const REGIME_DECAY_GRACE_BARS: u32 = 5;     // min bars before decay exit can fire
