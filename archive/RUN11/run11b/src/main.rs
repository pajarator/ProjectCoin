//! RUN11b.1 — New Indicator Strategy Discovery (15 strategies)
//! Grid search across 19 coins × 15 strategies × param variations × exit modes

use run11b_lib::indicators::{self, Indicators};
use run11b_lib::strategies::{self, Candles, StratConfig};
...
const RESULTS_FILE: &str = "/home/scamarena/ProjectCoin/run11b_1_results.json";
const CHECKPOINT_FILE: &str = "/home/scamarena/ProjectCoin/run11b_1_checkpoint.json";
...
fn main() {
    println!("=== RUN11b.1 — New Indicator Strategy Discovery ===");
    println!("15 strategies × {} exit modes × 19 coins\n", EXIT_MODES.len());
