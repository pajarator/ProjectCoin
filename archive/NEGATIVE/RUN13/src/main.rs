//! RUN13.1 — STRAT1000 Remaining Strategy Discovery (11 strategies)
//! Grid search across 19 coins × 108 configs × 7 exit modes
...
const RESULTS_FILE: &str = "/home/scamarena/ProjectCoin/run13/run13_1_results.json";
const CHECKPOINT_FILE: &str = "/home/scamarena/ProjectCoin/run13/run13_1_checkpoint.json";
...
fn main() {
    println!("=== RUN13.1 — STRAT1000 Remaining Strategy Discovery ===");
    println!("11 strategies × {} exit modes × 19 coins\n", EXIT_MODES.len());
